...
@Controller
@RequestMapping(MediaClipFrameratesController.BASE_URI)
public class MediaClipFrameratesController extends GenericController<FmsFramerate> {
	
	public static final String BASE_URI = "/mediaclips/framerates";

	@Autowired
	private FmsFramerateService framerateService;

	@Override
	protected Class<FmsFramerate> getType() {
		return FmsFramerate.class;
	}

	@Override
	protected GenericService<FmsFramerate> getService() {
		return framerateService;
	}
	
	@RequestMapping(value="",method=RequestMethod.GET)
	@ResponseBody
	public List<FmsFramerate> list(
